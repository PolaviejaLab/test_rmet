 ...
 */
declare var experimentFrontendControllers: any;
...
var test_RMET = function($scope, $http, $cookies, $controller)
{
    ...
    */
    $scope.get_mode = function(): number
    {
        var modeStrings = {};
     ...
     */
    $scope.is_final = function(): boolean
    {
     ...
     */
    $scope.set_final = function(value?: boolean): void
    {
     ...
     */
    $scope.get_ready_key = function(): string
    {
     ...
     */
    $scope.mark_ready = function(clientId): number
    {
     ...
     */
    $scope.get_ready_count = function(): number
    {
        var key = $scope.get_ready_key();
     ...
     */
    $scope.set_trial = function(trialNr): boolean
    {
     ...
     */
    $scope.get_trial = function(): number
    {
    ...
    */
    $scope.get_response_index = function(): number
    {
    ...
    * to the next trial.
    */
    $scope.handle_keyboard_event = function(evt: KeyboardEvent): void
    {
        if($scope.get_mode() == $scope.Mode_Central)
            return;
     ...
     */
    $scope.mark_definition_request = function(): void
    {
    ...
    */
    ...
    $scope.is_next_allowed = function(): boolean
    {
    ...
    */
    $scope.previous = function(): boolean
    {
